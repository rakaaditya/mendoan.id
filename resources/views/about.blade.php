        ...
        <div class="col-md-5 col-md-offset-3 container-box">
            ...
            <div class="row content">
                <div class="col-md-12 col-xs-12 about">
                    ...
                    <p>Beberapa hari yang lalu, ketika mulai ramai tentang masalah hak paten "Mendoan", saya dan seorang senior saya, Mas <a href="http://soep.web.id/" target="_blank">Soep</a>, yang juga pegiat Gerakan Desa Membangun secara singkat mengeluarkan ide untuk membeli domain <a href="http://www.mendoan.id">mendoan.id</a>. Setelah domain di tangan kami, barulah terpikir mau diapakan domain ini. Akhirnya saya mencoba membuat sebuah aplikasi kecil yang sangat sederhana dan hanya sekadar untuk "mengaktifkan" domain ini. Dan aplikasi siap digunakan pada hari Jumat (6/11) lalu tepatnya sekitar pukul 18.00.</p>
                	<p>Tidak disangka, dengan bantuan dari komunitas, akun twitter @iniPurwokerto, serta teman-teman lainnya yang begitu antusias menyebarkan website ini, dalam 2 jam sudah ada 800-an orang yang mendukung dengan mengeklik sebuah tombol kecil di yang saya buat hanya dalam hitungan menit sambil ngemil kuaci di kantor.</p>
